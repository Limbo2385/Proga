...
void zadanie1(int n) { // на случайном наборе значений массива.
    ...
    for (i = 0; i < n; i++) arr2[i] = rand() % 100 + 1;
...
void zadanie2(int n) { // представл€ющем собой возрастающую последовательность чисел
    setlocale(0, "rus");
